...
I just wasted this week and let time waste by. Only thing I did was make a plan to make myself accountable, then being to lazy to implement it.
No worries though. No matter, incremental changes bro. Made a lot of checkpoints all at once. Obviously, I was not able to follow through.

Though, still a bit sad because I do have big expectations from myself. So, do need to have strong will.

Yeah, so this week just completed one assignment that i got and nothing else
